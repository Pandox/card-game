package br.com.pandox.cg.server.boot.environment;
...
@Configuration
@ComponentScan("br.com.pandox.cg.server")
@EnableJpaRepositories({"br.com.pandox.cg.server.infrastructure.repository"})
@EnableWebMvc
public class ApplicationInitializer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("br.com.pandox.cg.server.infrastructure.repository");
